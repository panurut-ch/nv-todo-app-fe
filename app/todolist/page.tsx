...
export default function TodoList() {
  ...
  const handleAddTask = async (title: string, description: string) => {
    try {
      ...
      const result: { isSuccess: boolean; data: Todo } = await response.json();
  ...
  const handleMarkSelectedAsDone = useCallback(() => {
    ...
    const tasksToMarkDone = todolist.filter((todo) =>
  ...
  const currentUserId = "your-current-user-id"; // Replace this with the actual current user ID
